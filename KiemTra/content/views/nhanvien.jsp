...
<body>
	<div>
        <form action="nhanvien" method="post" enctype="multipart/form-data">
            ...
            <input type="radio" name="position" value="Nam">Nhan vien
            <input type="radio" name="position" value="Nu">Truong Phong<br><br>
            <label for="">Tinh trang hon nhan</label>
            <input type="checkbox" name="family" value="family"><label>Doc Than</label><br><br>
            ...
            <input type="checkbox" name="hobby" value="Other">Other<br><br>
            <label for="">Ghi chu</label><br>
            <textarea name="ghichu" id="" cols="30" rows="10"></textarea><br>
